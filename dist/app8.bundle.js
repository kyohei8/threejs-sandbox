...
/***/ function(module, exports, __webpack_require__) {
	...
	var init = function init() {
	  ...
	  var line_material = new THREE.LineBasicMaterial({ color: 3158064 }),
	  ...
	  for (var i = 0; i <= 150; i++) {
	    ...
	    var color = "0x" + (toHex(x) + toHex(y) + toHex(z));
	    var material = new THREE.MeshBasicMaterial({ color: parseInt(color) });
...
/***/ }
/******/ ]);
//# sourceMappingURL=app8.bundle.js.map