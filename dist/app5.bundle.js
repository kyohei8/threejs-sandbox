...
/***/ function(module, exports, __webpack_require__) {
	...
	var randomVector3 = function randomVector3(xMin, xMax, yMin, yMax, zMin, zMax) {
	  return new THREE.Vector3(xMin + (xMax - xMin) * Math.random(), yMin + (yMax - yMin) * Math.random(), zMin + (zMax - zMin) * Math.random());
	};
	...
	var animate = (function (_animate) {
	  ...
	  if (Math.random() < delta) particleGroup.triggerPoolEmitter(11, randomVector3(-200, 200, 50, 200, -200, -100));
